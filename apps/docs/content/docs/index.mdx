...
lifetime; separate stores intentionally do not coordinate. Browser apps must
also register the service worker from the browser-dapp guide before rendering.
