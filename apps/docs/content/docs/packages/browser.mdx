...
teardown. See [Build a browser dapp](/docs/guides/browser-dapp) for the complete
service-worker, live-view, and hosting setup.
...
See [Browser packages and storage](/docs/guides/browser-bundlers) for lower-level
bundler and storage details.
