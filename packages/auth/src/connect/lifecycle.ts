 ...
 * - A bare interval string → that settle-check interval.
 *
 * @internal
 */
...
/**
 * Set or clear an identity's sync registration based on its derived protocol
 * scope.
 *
 ...
 *   sync-relevant grants remain so revoked protocols stop syncing.
 *
