# `@enbox/credentials` <!-- omit in toc -->

The `@enbox/credentials` package provides the following functionality:
...
```bash
npm install @enbox/common
npm install @enbox/dids
npm install @enbox/credentials
```

Then to import:

```javascript
import { VerifiableCredential, VerifiablePresentation, PresentationExchange } from '@enbox/credentials';
```
