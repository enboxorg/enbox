export const hkdfTestVectors = [
  {
    id           : 'rfc5869-A.1',
    hash         : 'SHA-256',
    baseKeyBytes : '0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b',
  ...
  },
  {
    id           : 'rfc5869-A.2',
    hash         : 'SHA-256',
    baseKeyBytes : '000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f202122232425262728292a2b2c2d2e2f303132333435363738393a3b3c3d3e3f404142434445464748494a4b4c4d4e4f',
