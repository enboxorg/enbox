...
1. Implement one or a combination of the `DataStore`, `MessageStore`, and `ResumableTaskStore` interfaces.
...
import { yourMessageStore, yourDataStore, yourResumableTaskStore } from 'your-custom-stores';
...
describe('Custom data store implementation', () => {
  TestSuite.runStoreDependentTests({
    ...
    resumableTaskStore: yourResumableTaskStore,
  });
});
```
