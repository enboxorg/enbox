...
export enum DwnErrorCode {
  ...
  IndexInvalidDistinctProperty = 'IndexInvalidDistinctProperty',
  ...
  MessageStoreRecordLimitInvalidMax = 'MessageStoreRecordLimitInvalidMax',
  MessageStoreRecordLimitInvalidScope = 'MessageStoreRecordLimitInvalidScope',
