...
type LegacySyncRecoveryState = { error: string; failedAt: string; nextRetryAt?: string };
...
export function isRetryableSyncRecovery(
  recovery: LegacySyncRecoveryState | undefined,
): recovery is LegacySyncRecoveryState {
