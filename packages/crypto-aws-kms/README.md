...
be used by [other libraries](https://github.com/enboxorg/enbox/enbox) in this monorepo when working
...
The Web5 Crypto AWS KMS extension is distributed as `@enbox/crypto-aws-kms` via
...
Install the latest version of `@enbox/crypto-aws-kms` using `npm` or your preferred package manager:

```shell
npm install @enbox/crypto-aws-kms
```

Example ESM import:

```js
import { AwsKeyManager } from "@enbox/crypto-aws-kms";
```

Example CJS require:

```js
const { AwsKeyManager } = require("@enbox/crypto-aws-kms");
```
...
[crypto-aws-kms-npm-badge]: https://img.shields.io/npm/v/@enbox/crypto-aws-kms.svg?style=flat&color=blue&santize=true
[crypto-aws-kms-npm-link]: https://www.npmjs.com/package/@enbox/crypto-aws-kms
[crypto-aws-kms-downloads-badge]: https://img.shields.io/npm/dt/@enbox/crypto-aws-kms?&color=blue
[crypto-aws-kms-build-badge]: https://img.shields.io/github/actions/workflow/status/enboxorg/enbox/enbox/tests-ci.yml?branch=main&label=build
[crypto-aws-kms-build-link]: https://github.com/enboxorg/enbox/enbox/actions/workflows/tests-ci.yml
[crypto-aws-kms-coverage-badge]: https://img.shields.io/codecov/c/gh/enboxorg/enbox/enbox/main?style=flat&token=YI87CKF1LI
[crypto-aws-kms-coverage-link]: https://app.codecov.io/github/enboxorg/enbox/enbox/tree/main/packages%2Fcrypto-aws-kms
[crypto-aws-kms-issues-badge]: https://img.shields.io/github/issues/enboxorg/enbox/enbox/package:%20crypto-aws-kms?label=issues
[crypto-aws-kms-issues-link]: https://github.com/enboxorg/enbox/enbox/issues?q=is%3Aopen+is%3Aissue+label%3A"package%3A+crypto-aws-kms"
